...
<html lang="en" dir="ltr">
  ...
  <body class='nosquish'>
    <div id='scrollcontent'>
        ...
        <div id="gallery">
          <div class="cardgroup">
            <div class="imgwrapper">
              <img src="<?php echo get_bloginfo('template_directory'); ?>/assets/silentgardenwest.png" alt="West Approach">
            </div>
            <h4>Silent Garden — Red Hook, Brooklyn</h4>
          </div>
      ...
      <h2 class='sectionmarker'>News</h2>
      <h4 class='datemarker'>November 15, 2020</h4>
      <p class='newstext'>Justin Sherrill was featured on the Parsons School of Constructed Environments blog</p>
      <h4 class='datemarker'>October 10, 2020</h4>
      <p class='newstext'>Our mixed-use residential complex design won second place in New Den-cities competition</p>
    ...
    <div id='fixedcontent' class="page-grid">
      ...
      <div id='vertical-nav'>
          <div id="sunbox-v" class='viewing nav-item'>
            <svg class='sunsvg' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 5375.26 5375.26"><g class='dotgroup'><g id="rotate"><g id="dots"><circle cx="1497.05" cy="2688.07" r="119.09"/><circle cx="2137.13" cy="2688.07" r="119.09"/><circle cx="2777.21" cy="2688.07" r="119.09"/><circle cx="3417.29" cy="2688.07" r="119.09"/><circle cx="4057.37" cy="2688.07" r="119.09"/><circle cx="4697.44" cy="2688.07" r="119.09"/></g><rect class="svgframe" class="cls-1" x="-0.37" y="-0.37" width="5376" height="5376"/></g></g><g class="sungroup"><circle class="sun" vector-effect='non-scaling-stroke' cx="2687.86" cy="2688.07" r="555.72"/></g>
            </svg>
          </div>
          <div id='navwrap'>
          <div class="section-link nav-item">
            <svg class='sunsvg' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 5375.26 5375.26"><g class='dotgroup'><g id="rotate"><g id="dots"><circle cx="1497.05" cy="2688.07" r="119.09"/><circle cx="2137.13" cy="2688.07" r="119.09"/><circle cx="2777.21" cy="2688.07" r="119.09"/><circle cx="3417.29" cy="2688.07" r="119.09"/><circle cx="4057.37" cy="2688.07" r="119.09"/><circle cx="4697.44" cy="2688.07" r="119.09"/></g><rect class="svgframe" class="cls-1" x="-0.37" y="-0.37" width="5376" height="5376"/></g></g><g class="sungroup"><circle class="sun" vector-effect='non-scaling-stroke' cx="2687.86" cy="2688.07" r="555.72"/></g>
            </svg>
            <h2>projects</h2>
          </div>
